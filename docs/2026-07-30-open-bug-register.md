...
Authoritative work queue as of 2026-08-12. The former 4,734-line register is preserved, without renumbering or
...
| B134 | OPEN / PRODUCT | ESP32/Heltec inbox storage is volatile, so delete is not durable across reboot. |
