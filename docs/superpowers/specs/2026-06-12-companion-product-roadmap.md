...
| A Messaging | **Messages screen rework** — pinned team thread + one compose button with the missing **DM path** | ✅ app | **D34 — done 2026-07-31**; fixes "you could not start a DM from Messages" |
