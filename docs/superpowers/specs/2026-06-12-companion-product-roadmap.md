...
| Teams v1 | **CL2 channel encryption** — `send_channel -e` · `enc:true` on team posts · `team_channel_no_key` · flag matrix | ⏸ | **Track C** — firmware unbuilt (gates AB4 stored location); interface buildable now |
