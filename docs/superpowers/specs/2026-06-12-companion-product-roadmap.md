...
| Messaging | **anti-spam send-pacing** — `limits` · `send_blocked`/`channel_sent` pushes · back-off | 🔜 app | **D29** — fw done; app decode + back-off + "retry in N s" TODO |
