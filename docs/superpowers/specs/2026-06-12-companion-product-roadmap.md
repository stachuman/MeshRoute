...
| Teams v1 | **Team QR (T-K4)** — `TeamCard` payload + Share (gated, private-key warning) / Scan → provision · grant-key action · key-state + no-key prompt | ✅ app | **D32 — built 2026-07-26 AHEAD of firmware** (99 tests); ⚠ verb/cfg token names pending T-K1/T-K3 |
