...
- **s18 keystone: BYTE-IDENTICAL** — meshroute engine **157373 / md5 `306c3cf4af65b56d6fc6415b964ad9f3`** (`lus -e meshroute simulation/s18_meshroute.json`; corrected 2026-06-15 — was the Lua `779015 / 77205506…`, the wrong engine) — the type-4 TLV must be inert for single-layer.
