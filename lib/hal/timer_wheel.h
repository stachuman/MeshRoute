...
class TimerWheel {
public:
    static constexpr uint32_t kCap = 90;   // matches the Hal "cap" caller-id contract (64->80 in Slice 3b for the dual-layer
                                           ...
                                           // 89->90 in §F-SL-1 for the parked-send re-flood scan [89]; ids 1..63 are dense)
