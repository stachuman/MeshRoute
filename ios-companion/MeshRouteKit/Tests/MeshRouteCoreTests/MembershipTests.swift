...
final class MembershipTests: XCTestCase {
    ...
    func testUnmanaged() {
        let m = LeafMembership.adopted(lineage: 0, epoch: 0, leaf: nil, layer: nil)
    ...
    func testJoining() {
        ...
        let m = LeafMembership(lineage: 41153, epoch: 0, leaf: "north field", layer: 2, synced: false)
    ...
    func testMember() {
        let m = LeafMembership.adopted(lineage: 41153, epoch: 3, leaf: "north field", layer: 2)
