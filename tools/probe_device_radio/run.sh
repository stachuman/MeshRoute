...
#
# V4-3 RF-seam gate. It host-compiles the REAL production device_radio.h and Heltec V4 board_rf.cpp against counting
# silicon/GPIO fakes, then checks the fw_main wiring the native suite cannot link. Controls must all go RED.
#
...
echo "== V4-3 production device-radio probe =="
...
echo "== V4-3 production Heltec board-RF probe =="
...
echo "== V4-3 production wiring checks =="
