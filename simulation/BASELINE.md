...
2. **Mobile / team self-checking scenarios** — `s21_mobile_dm_milestone`, `s22_mobile_team`, `s23_mobile_team_multihop` (the "Self-checking scenarios" section at the bottom): **0 assertion failures**, each. **NOT optional** — mandatory for ANY change, and especially any change touching the mobile / team / E2E-crypto planes. These are as required as the delivery suite.
